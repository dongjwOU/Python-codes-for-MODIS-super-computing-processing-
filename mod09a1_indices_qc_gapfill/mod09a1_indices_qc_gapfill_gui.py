...
6 a GUI to open csv file and report information to GUI.
"""
...
#filename = "C:\\2011\\processingMODIS\\csv_mod09a1_2008_43.135113_70.936508.csv"
...
try:
        ...
        print "trouble opening",filename,",try another name ..."
        ...
        if line[39]=='Yes':
                if j==1:
                        ...
                        if lines[j-2][39]=='No' and lines[j][39]=='No':
                                ...
                                filled = filled +1
                                #print line[-1]
                        elif lines[j-2][39]=='No' and lines[j][39]=='No':
